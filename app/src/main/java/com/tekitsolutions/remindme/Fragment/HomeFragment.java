...
public class HomeFragment extends Fragment implements AdapterInterface, HamburgerMenuInterface, Callback<String> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listAdapter = new ReminderListAdapter(getActivity(), listItems, HomeFragment.this, this);
    ...
    public void onClickReminderList(int position) {
        ...
        builder = new AlertDialog.Builder(getContext(), R.style.dialogBoxStyle);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int item) {
                ...
                if (items[item].equals(getResources().getString(R.string.view))) {
                    ...
                    startActivityForResult(intent, PICK_HOME);
    ...
    public void onResponse(Call<String> call, Response<String> response) {
        ...
        if (statusCode == 200) {
            if (dbAdapter.deleteReminder(reminderId)) {
                new AlarmReceiver().cancelAlarm(getContext(), reminderId);
